...
export default function Candidates() {
  ...
  // CV UPLOAD - Fixed implementation
  const handleCvUpload = async (e) => {
    ...
    try {
      ...
      console.error(err);
      alert('Failed to upload CV. Please ensure the "cvs" storage bucket exists in Supabase.');
    } finally {
      setUploading(false);
    }
  };
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6 pl-72">
      ...
      {/* RESULTS - Added Preview CV button */}
